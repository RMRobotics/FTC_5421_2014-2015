...
#pragma config(Motor,  mtr_S1_C1_1,     MotorFR,       tmotorTetrix, PIDControl)
#pragma config(Motor,  mtr_S1_C1_2,     MotorFL,       tmotorTetrix, PIDControl)
#pragma config(Motor,  mtr_S1_C2_1,     MotorBL,       tmotorTetrix, PIDControl)
#pragma config(Motor,  mtr_S1_C2_2,     MotorBR,       tmotorTetrix, PIDControl)
